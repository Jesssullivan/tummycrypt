...
assert_contains "$RESUME_EVIDENCE/push-storage-summary.env" "fresh_prefix_publish_true_rows=2"
...
assert_contains "$RESUME_EVIDENCE/push-storage-summary.env" "remote_conflict_check_false_rows=2"
