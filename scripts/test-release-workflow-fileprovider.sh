...
assert_contains "$DERIVE_RUN_PATHS_STEP" "FILEPROVIDER_TESTING_MODE="
assert_contains "$DERIVE_RUN_PATHS_STEP" "STALE_APP_GROUP_DIR=\"\${APP_GROUP_DIR}.stale-\${GITHUB_RUN_ID}-\${GITHUB_RUN_ATTEMPT}\""
assert_contains "$DERIVE_RUN_PATHS_STEP" "mv \"\$APP_GROUP_DIR\" \"\$STALE_APP_GROUP_DIR\""
