...
assert_contains "$EVIDENCE/storage-posture.env" "storage_object_model=large-sequential-fastcdc-for-git-pack"
...
assert_contains "$EVIDENCE/storage-posture.md" "raw Git \`.pack\` files use the large"
