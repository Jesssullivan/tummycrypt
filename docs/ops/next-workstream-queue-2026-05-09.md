...
3. Expendable real-project fleet proof.
   ...
   preserved, and `restore-proof-source-fix-empty-dirs-20260515T183805Z/`
   proves source-built fresh-tree restore for regular files, symlinks, synced
   state, and empty directories. Next, rebuild/prove package restore, then
   repeat with a `~/git/linux-xr-fast` shadow and package-backed fresh-tree
