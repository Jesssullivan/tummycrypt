...
- `git-repo-canary-oauth-mux-sourcebin-fresh-20260515T014640Z/` closes the
  ...
  Linux, but not to a packaged/current honey consumer. Version strings alone
  are not enough for repo dogfood readiness. Rebuild/publish Homebrew and
  reprove cross-host mounted parsing with packaged/current consumers before
