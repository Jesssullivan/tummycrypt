...
- `git-repo-canary-oauth-mux-sourcebin-fresh-20260515T014640Z/` closes the
  ...
  Version strings alone are not enough for repo dogfood readiness. Rebuild/publish
  Homebrew if Homebrew is the client lane, then run the larger clean
  `linux-xr-fast` stress canary and fresh-tree restore/rollback proof before
  moving any live repo into TCFS.
